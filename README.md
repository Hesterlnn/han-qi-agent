...
| 版本 | 适合人群 | 使用方式 |
|---|---|---|
| 普通聊天框版 | 希望快速体验、不想安装程序的用户 | 将提供的提示词和知识包加入常用聊天平台 |
...
- 联网检索默认关闭，只在用户主动打开或明确要求时使用；
- 考据或文献研究需要先指定、上传或添加材料；
- 情境和同人内容可以虚构，但不会把虚构内容当作真实史料；
- 请勿在公开文件中填写 API Key，个人配置应保存在本机的 `.env` 或本地配置文件中。
